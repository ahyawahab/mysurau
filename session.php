...
class fb{ //feedback
	protected
		$success	= true,//jika proses berjaya
		$registered	= true,//jika teregister/ sudah login
	...
	public function verification($id){
		...
		//Jika request proses dijumpa______________________________________________________________
		else if(method_exists($this,$id)){
			$this->id	= $id;
			$this->dt	= isset($_POST['dt'])?$_POST['dt']:"";// data
			return true; //tidak  perlu callback
        }
		//Jika request tidak dijumpa________________________________________________________________
        else{
			$this->success	= false;
			$this->data		= "Request tidak jumapa...";
			$this->writeFeedBack();
		}
	}
