...
<head>
  ...
  <title>Masjid As-Salam|Admin</title>
...
<div class="wrapper">
  <header class="main-header">
    <a href="" class="logo" onclick="location.reload()">
      <span class="logo-mini">AKIMIE</span>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        <li class="header">INFO MASJID </li>
		...
		<li><a data-target="jadwal"><i class="fa fa-calendar"></i> <span>Seting jadual</span></a></li>
		<li><a data-target="simulasi"><i class="fa fa-history"></i> <span>Simulasi Jadual</span></a></li>
		<li><a data-target="pengaturan"><i class="fa fa-cogs"></i> <span>Tetapan</span></a></li>
  ...
  <!-- Content Wrapper. Contains page content -->
	...
	<footer class="main-footer">
		<div class="pull-right">
		  <b>Version</b> 0.1by Akimie(Sept 2024)
		</div>
		<strong>Display Masjid</strong> DIGITAL
	</footer>
